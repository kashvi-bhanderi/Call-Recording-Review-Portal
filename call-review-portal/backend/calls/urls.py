...
from .views import ConsultantCallDetailAPIView, ExportDashboardCallsCSV, UploadGoodAudioToDriveAPIView
...
urlpatterns = [
    ...
    path("upload-to-drive/", UploadGoodAudioToDriveAPIView.as_view())
]
